...
const MASTER_PASSWORD = "Adzril2!";

// Auto-inject password ke dalam memori browser
localStorage.setItem('admin_secret_token', MASTER_PASSWORD);
localStorage.setItem('asmr_v3_session', 'active');
