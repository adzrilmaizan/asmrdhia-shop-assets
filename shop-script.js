...
const SHOP = {
    ...
    renderProducts() {
        ...
        list.forEach(p => {
            ...
            let badgeHTML = '';
            if (actualStock <= 0) badgeHTML = '<span class="absolute top-3 left-3 badge-red shadow-sm z-20">STOK HABIS</span>';
    ...
    viewProduct(id) {
        ...
        if(maxStock <= 0) { 
            btn.disabled = true; 
            document.getElementById('dm-add-text').innerText = "STOK HABIS";
